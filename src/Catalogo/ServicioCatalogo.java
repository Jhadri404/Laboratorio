...
public class ServicioCatalogo {
    ...
    public Iterator<Producto> createIteratorProductos() {
        return productoRepo.createIterator();
    }

    public Iterator<Categoria> createIteratorCategorias() {
        return categoriaRepo.createIterator();
    }
